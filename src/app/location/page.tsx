  ...
  return (
    <PageShell>
      <section className="container-shell grid gap-8 py-14 lg:grid-cols-[0.9fr_1.1fr]">
        <div>
          <h1 className="text-5xl text-[var(--brand-green)]">Location and pinned directions</h1>
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <Link href={property.googleDirectionsUrl} className="inline-flex rounded-full bg-[var(--brand-green)] px-5 py-3 font-semibold text-white">Open pinned directions</Link>
            <Link href={property.googleMapUrl} className="inline-flex rounded-full border border-[var(--brand-border)] px-5 py-3 font-semibold text-[var(--brand-charcoal)]">Open map pin</Link>
          </div>
        ...
        <div className="space-y-4">
          <div className="relative min-h-[360px] overflow-hidden rounded-[var(--radius-card)] bg-white shadow-[var(--shadow-soft)]">
            <Image src="/images/location/jb-suites-map-snippet.webp" alt="Map snippet showing JB Executive Suites near Shimoni Road in Kira, Mulawa." fill className="object-cover" sizes="50vw" />
          </div>
          <iframe
